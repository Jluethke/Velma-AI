...
**One-line description:** The retail buyer and the vendor each submit their real commercial requirements, margin needs, and concerns before vendor terms are set — Claude designs the trading terms that keep the shelf stocked, protect margins on both sides, and build a vendor relationship that lasts more than one season.
