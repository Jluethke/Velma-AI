...
| ACT | User rejects final output | **Targeted revision** -- ask which competitor section, evidence citation, or recommendation fell short and rerun only that phase. Do not regenerate the full brief. |
