...
from skillchain.tools.debugger.engine import DebugEngine
...
class TestCandidateDiversity:
    ...
    def test_zero_division_diversity(self):
        ...
        from skillchain.tools.debugger.fix_generator import FixGenerator
        from skillchain.tools.debugger.root_cause import RootCauseAnalysis
