...
import { formatFlowName as formatFlow } from '../utils/formatFlowName';
...
const SAMPLE_LISTINGS: (DiscoveryListing & { isSample: true })[] = [
  {
    ...
    role: 'host',
    title: 'Series B founder seeking lead investor — B2B SaaS, $1.2M ARR',
    description: 'Growing 15% MoM, ready to raise $3M. Looking for a lead investor who understands SMB SaaS. Happy to share the deck — let\'s align on terms and vision before diving in.',
    market: 'SaaS / B2B',
    tags: ['series-b', 'saas', 'fundraising', 'b2b'],
    status: 'active',
  ...
  },
  {
    ...
    id: 'sample-2',
    wallet_address: '0xsample',
    flow_slug: 'job-offer-negotiation',
    role: 'host',
    title: 'Negotiating a $265K engineering offer — first time, want a second opinion',
    description: 'Got an offer from a late-stage startup. Base is $265K but equity details are vague. First time negotiating at this level. Looking for someone who\'s been here to walk through it with me.',
    market: 'Career / Tech',
    tags: ['offer-negotiation', 'compensation', 'equity', 'career'],
    status: 'active',
  ...
  },
  {
    ...
    flow_slug: 'residential-buyer-agent',
    role: 'host',
    title: 'First-time homebuyer, pre-approved $850K, seeking buyer\'s agent — Austin',
    description: 'Pre-approved and ready to move in 60–90 days. Looking for a buyer\'s agent in Austin who specializes in first-time buyers and won\'t rush us into a bad decision.',
    market: 'Real Estate',
    tags: ['first-time-buyer', 'austin', 'pre-approved', 'real-estate'],
    status: 'active',
  ...
  },
  {
    ...
    id: 'sample-4',
    wallet_address: '0xsample2',
    flow_slug: 'personal-trainer-client',
    role: 'guest',
    title: 'NASM-certified trainer — post-rehab and strength, 4 spots open',
    description: 'Certified trainer with 7 years experience, specializing in post-injury rehab and strength for people over 40. Remote or in-person (Austin). Taking 4 new clients — let\'s see if we\'re a match.',
    market: 'Health / Fitness',
    tags: ['personal-trainer', 'strength', 'post-rehab', 'wellness'],
    status: 'active',
  ...
  },
  {
    ...
    role: 'guest',
    title: 'Executive coach available — scaling teams from 10 to 100, 3 spots open',
    description: 'Coached 50+ operators through hypergrowth — hiring, board dynamics, founder burnout. Currently taking 3 clients. Prefer Series A/B stage where the chaos is real. Let\'s talk.',
    market: 'Executive Coaching',
    tags: ['coaching', 'leadership', 'scaling', 'founders'],
    status: 'active',
